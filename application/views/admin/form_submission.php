...
<br>
  <div class="row">
    <form class="col push-l3 push-m3 push-s2 l6 m6 s8" method="post" action="<?php echo base_url()."/admin/create_submission"; ?>">


      <div class="row">
        <div class="input-field">
          <input name="no_surat_keluar" type="text" class="validate">
      ...
      <div class="row">
        <div class="input-field">
          <input name="nama_acara" type="text" class="validate">
      ...
      <div class="row">
        <div class="input-field">
          <input name="nama_pemohon" type="text" class="validate">
      ...
      <div class="row">
        <div class="input-field">
          <input name="nim_pemohon" type="text" class="validate">
      ...
      <div class="row">
        <div class="input-field">
          <input name="nama_penerima" type="text" class="validate">
